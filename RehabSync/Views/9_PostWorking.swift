            ...
            VStack {
                    ...
                    VStack(spacing: 16) {
                        ...
                        HStack(spacing: 16) {
                            ...
                            ZStack {
                                RoundedRectangle(cornerRadius: 8)
                                    .fill(Color(red: 0.85, green: 0.93, blue: 0.97))
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 8)
                                            .stroke(Color(red: 0.369, green: 0.690, blue: 0.824), lineWidth: 3)
                                    )
                                ...
                                GeometryReader { geo in
                                    ...
                                    VStack(spacing: 0) {
                                        Text(comparisonMessage(blueHitCount))
                                            .font(.system(size: 20, weight: .semibold))
                                            .foregroundStyle(Color(red: 0.14, green: 0.32, blue: 0.45))
                                            .lineLimit(1)
                                            .minimumScaleFactor(0.5)
                                            .frame(height: 24)
                                        Spacer()
                                        HStack(alignment: .bottom, spacing: 16) {
                                            VStack(spacing: 4) {
                                                BarValueText(value: 0 * barGrowProgress, suffix: " 個", color: Color(red: 0.14, green: 0.32, blue: 0.45))
                                                    Rectangle()
                                                        .fill(Color(red: 0.70, green: 0.85, blue: 0.94))
                                                        .frame(width: barWidth, height: (0 > blueHitCount ? 60 : 30) * barGrowProgress)
                                            }
                                            VStack(spacing: 4) {
                                                BarValueText(value: Double(blueHitCount) * barGrowProgress, suffix: " 個", color: Color(red: 0.14, green: 0.32, blue: 0.45))
                                                    Rectangle()
                                                        .fill(Color(red: 0.369, green: 0.690, blue: 0.824))
                                                        .frame(width: barWidth, height: (0 >= blueHitCount ? 30 : 60) * barGrowProgress)
                                            }
                                        }
                                        Rectangle()
                                            .fill(Color(red: 0.14, green: 0.32, blue: 0.45))
                                            .frame(height: 2)
                                        HStack(spacing: 16) {
                                            Text("--")
                                                .font(.system(size: 20, weight: .semibold))
                                ...
                                ZStack {
                                    Circle().fill(Color(red: 0.369, green: 0.690, blue: 0.824))
                        ...
                        HStack(spacing: 16) {
                            ZStack {
                                ...
                                GeometryReader { geo in
                                    ...
                                    VStack(spacing: 0) {
                                        Text(comparisonMessage(redHitCount))
                                            .font(.system(size: 20, weight: .semibold))
                                        ...
                                        HStack(alignment: .bottom, spacing: 16) {
                                            VStack(spacing: 4) {
                                                BarValueText(value: 0 * barGrowProgress, suffix: " 個", color: Color(red: 0.55, green: 0.15, blue: 0.13))
                                                    Rectangle()
                                                        .fill(Color(red: 0.97, green: 0.75, blue: 0.73))
                                                        .frame(width: barWidth, height: (0 > redHitCount ? 60 : 30) * barGrowProgress)
                                            }
                                            VStack(spacing: 4) {
                                                BarValueText(value: Double(redHitCount) * barGrowProgress, suffix: " 個", color: Color(red: 0.55, green: 0.15, blue: 0.13))
                                                    Rectangle()
                                                        .fill(Color(red: 0.910, green: 0.306, blue: 0.290))
                                                        .frame(width: barWidth, height: (0 >= redHitCount ? 30 : 60) * barGrowProgress)
                                            }
                                        }
                                        Rectangle()
                                ...
                                ZStack {
                                    Circle().fill(Color(red: 0.910, green: 0.306, blue: 0.290))
                                    Circle().strokeBorder(Color.black, lineWidth: 1.5)
                                }
                                .frame(width: 40, height: 40)
                                .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topLeading)
                            ...
                            ZStack {
                                ...
                                GeometryReader { geo in
                                    ...
                                    VStack(spacing: 0) {
                                        Text(comparisonMessage(yellowHitCount))
                                            .font(.system(size: 20, weight: .semibold))
                                        ...
                                        HStack(alignment: .bottom, spacing: 16) {
                                            VStack(spacing: 4) {
                                                BarValueText(value: 0 * barGrowProgress, suffix: " 個", color: Color(red: 0.55, green: 0.45, blue: 0.05))
                                                    Rectangle()
                                                        .fill(Color(red: 0.99, green: 0.93, blue: 0.65))
                                                        .frame(width: barWidth, height: (0 > yellowHitCount ? 60 : 30) * barGrowProgress)
                                            }
                                            VStack(spacing: 4) {
                                                BarValueText(value: Double(yellowHitCount) * barGrowProgress, suffix: " 個", color: Color(red: 0.55, green: 0.45, blue: 0.05))
                                                    Rectangle()
                                                        .fill(Color(red: 0.957, green: 0.871, blue: 0.235))
                                                        .frame(width: barWidth, height: (0 >= yellowHitCount ? 30 : 60) * barGrowProgress)
                                            }
                                        }
                                        Rectangle()
                                ...
                                ZStack {
                                    Circle().fill(Color(red: 0.957, green: 0.871, blue: 0.235))
                                    Circle().strokeBorder(Color.black, lineWidth: 1.5)
                                }
                                .frame(width: 40, height: 40)
                                .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topLeading)
