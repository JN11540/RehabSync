...
private struct PostWorking12ExgCard: View {
    ...
    var body: some View {
        ...
        .task(id: deviceId) {
            ...
            dataPoints = rows.map { row in
                PostWorking12ExgPoint(time: Double(row.timestamp - Int64(setStartTimeMs)) / 1000.0, uv: Double(row.value) * GameDataExporter.exgMicrovoltScale)
            }
        }
    }
}
        ...
        ZStack(alignment: .topLeading) {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    PostWorking12ExgCard(title: "大腿 Channel 0", treatmentResultId: treatmentResultId, deviceId: thighDeviceId, channel: 0, setStartTimeMs: setStartTimeMs, setEndTimeMs: setEndTimeMs)
                    PostWorking12ExgCard(title: "大腿 Channel 1", treatmentResultId: treatmentResultId, deviceId: thighDeviceId, channel: 1, setStartTimeMs: setStartTimeMs, setEndTimeMs: setEndTimeMs)
                    PostWorking12ExgCard(title: "小腿 Channel 0", treatmentResultId: treatmentResultId, deviceId: calfDeviceId, channel: 0, setStartTimeMs: setStartTimeMs, setEndTimeMs: setEndTimeMs)
                    PostWorking12ExgCard(title: "小腿 Channel 1", treatmentResultId: treatmentResultId, deviceId: calfDeviceId, channel: 1, setStartTimeMs: setStartTimeMs, setEndTimeMs: setEndTimeMs)
                }
                .padding(28)
                .padding(.top, 60)
